		...
		<?php endif; ?>
            ...
            <div class="content-project">
				...
				<?php wp_reset_postdata(); ?>
                    <h1 style="text-transform:uppercase; letter-spacing: 2px; font-weight: normal;"><?php the_title(); ?></h1>
                    <div class="content-right-resources-blog">
                        ...
                        if( $latest_cat_post->have_posts() ) : while( $latest_cat_post->have_posts() ) : $latest_cat_post->the_post();  ?>
							...
							<div class="resources-blog-content">
                                ...
                                <a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Read More About: %s', 'twentytwelve' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><span class="read-more" style="float: right; width: 75px;">Read More ></span></a><br /><br />
                ...
                <p style="margin-left: 110px;"><a style="color: #F78E1E;" href="/category/ans-blog/"><< Older Posts</a></p>
