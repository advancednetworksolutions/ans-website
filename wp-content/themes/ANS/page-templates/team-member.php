            ...
            <div class="content-project">
				...
				<?php  
						...
						$args = array(
							'post_status' => 'publish',
							'post_type' => 'bio',
							'meta_key' => 'blogger_order_number',
							'orderby' => 'meta_value_num',
							'order' => 'ASC'
						);
                        $post_type = new WP_Query($args); ?>
						<?php
							$count_posts = wp_count_posts('bio')->publish;
							$keep = 0;
							?>
                        ...
                        <div class="industries">
                            ...
                            <div class="bio-content">
                                <h1><?php the_title(); ?></h1>
                                <div><img src="<?php the_field('bio_picture'); ?>" width="222" style="float: left; padding-right: 10px;" /></div>
                                <div><?php the_field('bloggers_information'); ?></div>
