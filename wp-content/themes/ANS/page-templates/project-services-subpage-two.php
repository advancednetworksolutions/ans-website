<?php
/**
 * Template Name: Project Services Subpage Two
 *
            ...
            <div class="content-project">
                ...
                <div class="key-bottom-content">
                    ...
                    <div class="key-bottom-contact">
						...
						<?php if ($_GET['service'] == 'managed') :  ?>
							<h3>All-inclusive service and fixed costs: <strong>Managed Services</strong></h3>
							<p>Improved efficiency, greater productivity, and a rapid return on investment</p>
