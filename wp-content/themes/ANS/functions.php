...
function twentytwelve_setup() {
	...
	'secondary' => __( 'Seconary Menu', 'twentytwelve'),
        'third' => __( 'Third Menu', 'twentytwelve'),
        'forth' => __( 'Forth Menu', 'twentytwelve'),
		'fifth' => __( 'Fifth Menu', 'twentytwelve'),
) );
...
class Walker_Nav_Pointers extends Walker_Nav_Menu
{
    ...
    function start_lvl( &$output, $depth = 0, $args = array() )
    {
        ...
        $output .= "\n$indent<div class=\"dropdown_4columns\"><ul class=\"sub-menu\">\n";
        $output .= "";
    }
